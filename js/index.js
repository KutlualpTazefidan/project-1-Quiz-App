import expandableButton from "./class/buttonExpansion.js";
...
const newQuestionButton = document.querySelector('[data-js="add-questions"]');
const questionsForm = document.querySelector('[name="submit-form-contents"]');
